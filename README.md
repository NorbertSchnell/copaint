...
* open a shell/terminal and change the current directory to the downloaded (unzipped) `copaint ` project directory
* run `npm install`

To run the application:
* run `npm run watch` in the `copaint` project directory in an open a shell/terminal
